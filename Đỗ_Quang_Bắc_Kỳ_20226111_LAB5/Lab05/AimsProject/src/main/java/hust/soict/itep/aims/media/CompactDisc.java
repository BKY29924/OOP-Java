...
public class CompactDisc extends Disc implements Playable {
	...
	public void addTrack(Track track) {
		...
		for (Track item : tracks) { // Renamed loop variable to "item"
			if (item.equals(track)) { // Correct comparison between tracks' track and input track
				isIdentical = true;
				break;
			}
		}

		if (isIdentical) { // If the track already exists, don't add it again
