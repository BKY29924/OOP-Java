...
public class InvalidMediaException extends StoreException {
	...
	public InvalidMediaException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
